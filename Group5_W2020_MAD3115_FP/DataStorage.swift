...
//    }
    ...
    func loadPersonDetails(){
        ...
        let customer3 = Customer(id: 3, firstName: "Jyothi", lastName: "Thomas", gender: "Female", birthDate: "Sep 5, 1990", mobileNumber: "4574359876", email: "jyotit123@gmail.com", userName: "jyotithomas", password: "thomas12".encrypt(key: "encrypt", iv: "encrypt") ?? "encrypt", address: "123, Shepherd Ave", city: "Scorbrough")
...
//        }
        ...
        let owner3 = Owner(id: 3, firstName: "Jyothi", lastName: "Thomas", gender: "Female", birthDate: "Oct 03, 1990", mobileNumber: "4569872457", email: "Jthomas@yahoo.com", userName: "jyotiT", password: "thomas".encrypt(key: "encrypt", iv: "encrypt") ?? "encrypt", companyTitle: "twitterbeat", businessLandLineNumber: "235987", website: "macromedia.com")
